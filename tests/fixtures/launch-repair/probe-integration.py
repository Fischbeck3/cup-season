...
repo=pathlib.Path('/Users/fischbeck3/cup-season/.claude/worktrees/audit-integration')
repair=pathlib.Path('/Users/fischbeck3/cup-season/.claude/worktrees/audit-integration')
...
try:
 ...
 print('PASS baseline: 255 migrations applied to new local PG17 cluster',flush=True)
