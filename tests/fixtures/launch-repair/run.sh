...
python3 tests/fixtures/launch-repair/verify.py --socket "$SOCK" --port "$PORT" --export-dir "$root/client-fixtures"
CS_BOOK_INTEGRATION_FIXTURES="$root/client-fixtures" node tests/season-book.test.mjs
