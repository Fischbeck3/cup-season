...
| 9 | **a forfeit** | "A forfeit is a bet for pride. It settles on a tap and goes on the record — never on the books." | the *Post a forfeit* sheet, and the person page's *Put something on it* | D131 / T-02; D64 |
...
| your number · index · Handicap index · IDX · starter index · your number that day | **your number** everywhere · **Handicap index** only as the card's figure label · **starter** until three rounds · **NUMBER** as the live column head (`IDX` retires) | one word for one figure; "index" is the governing body's word, not the group's | **kept** — D1; L-14 | onboarding: *"Your number builds itself from three posted rounds. This just gets you started."* |
| playing number · vs your playing number · Avg vs index (`IndividualRaceView.swift:52`) · vs index (`ReceiptSheets.swift:111`, `CupFinalRaceView.swift:106`) · R | **playing number** stays **on the receipt only**; every other surface says **vs your number**; the column reads **Avg vs your number**; **R → Rounds** | D209 made a second noun to solve a receipt problem; scope it to the receipt rather than rename it | **kept, scoped** — L-14 / T-07. *The reader proposed overriding D209; declined (§7, note 1)* | the receipt *How this round scored*: *"Your number that day 14.2"* · *"Playing number 13.5 — your number at 95%"* |
...
| Torched it · Beat your number · Played to it · A little loose · Posted anyway | **keep all five**, from **one producer** (`band_name(p_pvi)`, **R13**) | golf-native, already loved, seven copies today | **kept** — T-15; spec §2.2 | the composer's *How points work*, and the epilogue |
...
| stake (pride) · Post a stake (`PotPane.swift:133,189`) · The other stakes · Put it on the books · Settle the stake | **a forfeit** · **Post a forfeit** · **Bets for pride** (the head) · **Put it on the record** · **Settle the forfeit** | "stake" was money on one pane and never-money on the next — the audit's nearest thing to a P0 | **kept** — D131 / T-02; D64 | the *Post a forfeit* sheet: definition-ledger sentence #9 |
...
6. **"Bragging rights" stays** at $0 on every dial. It is the product's best-loved string and the whole argument that money is optional.
