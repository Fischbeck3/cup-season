...
Index only — files live where they live. OS layer: `../StudioOS`.
...
| current palette / stronger Compete application (proposal) | `docs/planning/2026-09-15-current-palette-application.md` |
...
`../StudioOS/projects/cupseason.md`.
