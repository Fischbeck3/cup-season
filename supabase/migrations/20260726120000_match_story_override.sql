-- ============================================================================
-- Cup Season — D75: the match branch accepts a client-composed story
--
-- Everyone-for-themselves match play (round robin singles) has no two sides
-- for the server to compose "X def. Y" from — the client sends the finished
-- story (per-player records), exactly as wolf/skins/sunningdale already do.
-- The match branch now PREFERS p_result->>'story' when present and falls back
-- to the 2-side composition otherwise, so classic matches are untouched.
-- Function body copied verbatim from 20260725220000 with that one edit.
-- ============================================================================
