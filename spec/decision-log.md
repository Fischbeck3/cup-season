...
### D146 · ⚑ OPEN — the Ryder's finish tells the truth about the score but not about the reason
*(2026-08-30, Ryder simulation. MECHANIC/UI (4–5). NOT built.)*
...
### D147 · ⚑ OPEN — two Ryder dials are advertised but not wired
*(2026-08-30, Ryder simulation + engine spec. MECHANIC (4). NOT built.)*
...
### D148 · ⚑ OPEN — the Ryder roster has no consent, and an attached league cannot watch
*(2026-08-30, engine spec. IA/mechanic (3–4). NOT built.)*
