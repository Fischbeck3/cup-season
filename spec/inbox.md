...
**2026-09-15 · Pride-bet purpose and placement / Gameplay + Social:** owner cannot tell what the composer does. Source confirms a prose record with manual settlement and no acceptance flow, under the existing no-push rule. Proposal: contextual agreement attached to an understood contest, with clear terms, acceptance and result source; requires an explicit lifecycle/notification decision, not another rename. Preserve old records. Tracked as F6 in [phone findings](../docs/planning/2026-09-15-phone-findings-and-appreciation.md#f6--pride-bet-meaning-placement-and-agreement).
