...
- `HomeWireCourse` — a course with a star rail, drawn thumbnail and sub-line — is **fully built with no producer**, and is §7 of his own brief (*&ldquo;Course discovery &mdash; PUNTA BRAVA &middot; ★★★★★&rdquo;*). It also settles half of the tree's Decision C: **he specified a course rating on 2026-09-06.**
